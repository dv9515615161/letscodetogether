...
class SettingsRepository(private val context: Context) {
    ...
    private fun Preferences.toSettings(): RideScoreSettings {
        ...
        return RideScoreSettings(
            ...
            slowTrafficFactor = this[Keys.SLOW_TRAFFIC] ?: d.slowTrafficFactor,
            requireAcceptToSurviveTraffic =
                this[Keys.SURVIVE_TRAFFIC] ?: d.requireAcceptToSurviveTraffic,
            ...
            commissionExemptAmount =
                this[Keys.COMMISSION_EXEMPT] ?: d.commissionExemptAmount,
    ...
    private fun androidx.datastore.preferences.core.MutablePreferences.write(s: RideScoreSettings) {
        ...
        this[Keys.SLOW_TRAFFIC] = s.slowTrafficFactor
        this[Keys.SURVIVE_TRAFFIC] = s.requireAcceptToSurviveTraffic
        ...
        this[Keys.COMMISSION_EXEMPT] = s.commissionExemptAmount
    ...
    private object Keys {
        ...
        val SLOW_TRAFFIC = doublePreferencesKey("slow_traffic_factor")
        val SURVIVE_TRAFFIC = booleanPreferencesKey("require_accept_survives_traffic")
        ...
        val COMMISSION_EXEMPT = doublePreferencesKey("commission_exempt_amount")
