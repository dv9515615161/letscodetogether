...
object OfferCsv {
    ...
    val COLUMNS = listOf(
        ...
        "pickup_min", "pickup_min_estimated", "trip_min", "trip_min_estimated", "total_min",
        "return_km", "return_min",
        "fuel_cost", "maintenance_cost", "platform_fee", "net_earning",
        "gross_per_hour", "net_per_hour", "net_per_hour_in_traffic", "gross_per_km", "net_per_km",
    ...
    private fun row(
        ...
        return listOf(
            ...
            num(ride.tripTimeMinutesCounted),
            ride.tripTimeEstimated.toString(),
